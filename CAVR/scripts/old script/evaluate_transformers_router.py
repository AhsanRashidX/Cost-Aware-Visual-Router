"""
Evaluate transformers router on DocVQA dataset
"""
...
print("="*70)
print("TRANSFORMERS ROUTER EVALUATION - DocVQA")
print("="*70)

# Step 1: Load router
print("\n[1/5] Loading transformers router...")

try:
    from scripts.transformers_router import TransformersRouter
...
print("\n" + "="*70)
print("TRANSFORMERS ROUTER RESULTS")
print("="*70)
...
# Save results
output = {
    'router_type': 'transformers_router',
    'total_queries': total,
    'accuracy': accuracy,
...
output_path = Path('./logs/results/transformers_router_docvqa.json')
